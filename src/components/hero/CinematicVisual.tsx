    ...
    <div className="relative w-full h-[450px] md:h-[550px] lg:h-[750px] flex items-center justify-center lg:justify-end z-0 mt-8 lg:mt-0 lg:ml-20 perspective-[2000px]">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute -left-10 md:-left-20 top-4 md:top-12 z-30 scale-105 md:scale-110"
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-3 md:p-4 flex items-center gap-3 w-32 md:w-40 shadow-[0_0_25px_rgba(28,69,104,0.3)] border-[1.5px] border-neuro-blue">
            <div className="w-9 h-9 md:w-12 md:h-12 rounded-lg bg-neuro-blue/10 flex-shrink-0 flex items-center justify-center">
              <TrendingUp className="w-5 h-5 md:w-6 md:h-6 text-neuro-blue" />
            </div>
            <div>
              <p className="text-[10px] md:text-[11px] font-black text-neuro-blue uppercase tracking-wider">TDAH</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-2.5 md:p-3 flex items-center gap-3 w-40 md:w-48 shadow-[0_15px_35px_rgba(0,0,0,0.05)] border border-slate-100">
            <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-neuro-cyan/5 flex-shrink-0 flex items-center justify-center border border-neuro-cyan/10">
              <Brain className="w-4 h-4 md:w-5 md:h-5 text-neuro-cyan" />
            </div>
            <div>
        ...
        <motion.div
          ...
          className="absolute -right-10 md:-right-20 top-4 md:top-12 z-30 scale-105 md:scale-110"
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-3 md:p-4 flex items-center gap-3 w-32 md:w-40 shadow-[0_0_25px_rgba(66,182,165,0.4)] border-[1.5px] border-neuro-cyan">
            <div className="w-9 h-9 md:w-12 md:h-12 rounded-lg bg-neuro-cyan/10 flex-shrink-0 flex items-center justify-center">
              <Star className="w-5 h-5 md:w-6 md:h-6 text-neuro-cyan fill-neuro-cyan" />
            </div>
            <div>
              <p className="text-[10px] md:text-[11px] font-black text-neuro-cyan uppercase tracking-wider">TEA</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute left-0 md:-left-8 bottom-12 md:bottom-20 z-20"
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-2.5 md:p-3 flex items-center gap-3 w-36 md:w-48 shadow-[0_15px_35px_rgba(0,0,0,0.05)] border border-slate-100">
            <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-neuro-orange/5 flex-shrink-0 flex items-center justify-center border border-neuro-orange/10">
              <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-neuro-orange" />
            </div>
            <div>
        ...
        <motion.div
          ...
          className="absolute left-1/2 -translate-x-1/2 -bottom-4 md:-bottom-8 z-20 hidden sm:block"
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-2.5 md:p-3 flex items-center gap-3 w-40 md:w-48 shadow-[0_15px_35px_rgba(0,0,0,0.05)] border border-slate-100">
        ...
        <motion.div
          ...
          className="absolute right-0 md:-right-12 bottom-8 md:bottom-16 z-20"
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-2.5 md:p-3 flex items-center gap-3 w-32 md:w-36 shadow-[0_15px_35px_rgba(0,0,0,0.05)] border border-slate-100">
            <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-neuro-cyan/5 flex-shrink-0 flex items-center justify-center border border-neuro-cyan/10">
              <BookOpen className="w-4 h-4 md:w-5 md:h-5 text-neuro-cyan" />
            </div>
            <div>
